...
mixin _$BugAiState {
 ...
 bool get isStreaming; String get text; bool get done; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,isStreaming,text,done,errorMessage);

@override
String toString() {
  return 'BugAiState(isStreaming: $isStreaming, text: $text, done: $done, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 bool isStreaming, String text, bool done, String? errorMessage
});
...
/// Create a copy of BugAiState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? isStreaming = null,Object? text = null,Object? done = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isStreaming,  String text,  bool done,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BugAiState() when $default != null:
return $default(_that.isStreaming,_that.text,_that.done,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isStreaming,  String text,  bool done,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _BugAiState():
return $default(_that.isStreaming,_that.text,_that.done,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isStreaming,  String text,  bool done,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _BugAiState() when $default != null:
return $default(_that.isStreaming,_that.text,_that.done,_that.errorMessage);case _:
  return null;
...
class _BugAiState implements BugAiState {
  const _BugAiState({this.isStreaming = false, this.text = '', this.done = false, this.errorMessage});
...
/// Create a copy of BugAiState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? isStreaming = null,Object? text = null,Object? done = null,Object? errorMessage = freezed,}) {
