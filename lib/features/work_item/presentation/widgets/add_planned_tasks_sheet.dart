...
void showAddPlannedTasksSheet(BuildContext context, {required DateTime day}) {
  showModalBottomSheet<void>(
    ...
    builder: (_) => BlocProvider(
      create: (_) => getIt<PlanWorkItemsCubit>()..init(),
...
class _AddPlannedTasksView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<PlanWorkItemsCubit, PlanWorkItemsState>(
      builder: (context, state) {
        final cubit = context.read<PlanWorkItemsCubit>();
        return SafeArea(
          top: false,
  ...
  Future<void> _confirm(BuildContext context, PlanWorkItemsCubit cubit) async {
  ...
  void _showQuickDescription(BuildContext context, WorkItem task) {
