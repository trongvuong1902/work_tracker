...
import '../../domain/models/work_item_time_log.dart';
import '../../domain/work_item_repository.dart';
import '../../domain/work_item_time_log_repository.dart';

part 'work_item_time_log_state.dart';
part 'work_item_time_log_cubit.freezed.dart';
...
@injectable
class WorkItemTimeLogCubit extends Cubit<WorkItemTimeLogState> {
  WorkItemTimeLogCubit(this._timeLogRepository, this._taskRepository)
    : super(const WorkItemTimeLogState());
  ...
  Future<void> load() async {
    ...
    try {
      ...
      final byDay = <DateTime, List<WorkItemTimeLog>>{};
