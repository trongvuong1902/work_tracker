...
part 'plan_work_items_state.dart';
part 'plan_work_items_cubit.freezed.dart';
...
@injectable
class PlanWorkItemsCubit extends Cubit<PlanWorkItemsState> {
  PlanWorkItemsCubit(this._repository) : super(const PlanWorkItemsState());
