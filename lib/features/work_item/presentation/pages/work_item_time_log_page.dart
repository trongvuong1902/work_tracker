...
class WorkItemTimeLogPage extends StatelessWidget {
  const WorkItemTimeLogPage({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => getIt<WorkItemTimeLogCubit>()..load(),
      child: const _WorkItemTimeLogView(),
    );
  }
}

class _WorkItemTimeLogView extends StatelessWidget {
  const _WorkItemTimeLogView();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Manage task times')),
      floatingActionButton: BlocBuilder<WorkItemTimeLogCubit, WorkItemTimeLogState>(
      ...
      body: SafeArea(
        child: BlocBuilder<WorkItemTimeLogCubit, WorkItemTimeLogState>(
...
class _EntryRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final cubit = context.read<WorkItemTimeLogCubit>();
    return Dismissible(
...
Future<void> _showAddSheet(BuildContext context, List<WorkItem> tasks) async {
  final cubit = context.read<WorkItemTimeLogCubit>();
