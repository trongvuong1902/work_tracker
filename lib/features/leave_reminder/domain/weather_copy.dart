...
/// Maps an Open-Meteo WMO weather code to a bare emoji, with no condition
/// text — used for the condensed forecast shorthand in the leave-reminder
/// heads-up digest.
///
/// See https://open-meteo.com/en/docs (WMO Weather interpretation codes).
String weatherEmoji(int openMeteoWeatherCode) {
  switch (openMeteoWeatherCode) {
    case 0:
      return '☀️';
    case 1:
